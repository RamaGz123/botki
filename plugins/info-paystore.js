...
let info = `
╭━━━━「 *SEWA* 」
┊⫹⫺ *Hemat:* _${2}k/grup (1 minggu)_
┊⫹⫺ *Normal:* _${4}k/grup (1 bulan)_
┊⫹⫺ *Standar:* _${5}k/grup (2 bulan)_
┊⫹⫺ *Pro:* _${7}k/grup (4 bulan)_                                                      
┊⫹⫺ *Vip:* = _${10}k/grup (12 bulan)_
╰═┅═━––––––๑

╭━━━━「 *PREMIUM* 」
┊⫹⫺ *Hemat:* _${1}k (1 minggu)_
┊⫹⫺ *Normal:* _${3}k (1 bulan)_
┊⫹⫺ *Pro:* _${5}k (4 bulan)_
┊⫹⫺ *Vip:* _${7}k (8 bulan)_                                               
┊⫹⫺ *Permanent (jual script bot):* = _${15}k (Unlimited)_
╰═┅═━––––––๑
